...
EUvax <- read.csv("/Users/knith/Downloads/EUvaccine.csv") #####this reads in the data file I made you will need to change the path to your computer
View(EUvax)
