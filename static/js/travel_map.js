...
const tmCountries = [
  ...
  { name:"China", lat:35.0, lng:105.0, flag:"🇨🇳", desc:"Ancient wonders, futuristic cities, and the Great Wall stretching to the horizon.",
    cities:[
      {name:"Beijing",  lat:39.9042, lng:116.4074, type:"sightseeing",  desc:"Imperial capital, home to the Forbidden City and Great Wall.", imgs:["beijing_1","beijing_2","beijing_3","beijing_4"]},
      ...
      {name:"Xi'an",    lat:34.3416, lng:108.9398, type:"culture", desc:"Ancient capital, home of the Terracotta Army.", imgs:["xian_1","xian_2","xian_3","xian_4"]},
    ]},
  ...
  { name:"Ethiopia", lat:9.5, lng:39.5, flag:"🇪🇹", desc:"Ancient rock churches, coffee origins, and breathtaking highland landscapes.",
    cities:[
      {name:"Addis Ababa", lat:9.0320, lng:38.7469, type:"sightseeing", desc:"Africa's diplomatic capital, high-altitude city with rich culture.", imgs:["addis_ababa_1","addis_ababa_2","addis_ababa_3","addis_ababa_4"]},
    ]},
  ...
  { name:"Finland", lat:62.0, lng:25.0, flag:"🇫🇮", desc:"A thousand lakes, Nordic saunas, and the magical Northern Lights.",
    cities:[
      {name:"Helsinki", lat:60.1699, lng:24.9384, type:"sightseeing", desc:"Design capital on the Baltic, cathedral squares and saunas.", imgs:["helsinki_1","helsinki_2","helsinki_3","helsinki_4"]},
    ]},
  ...
  { name:"Germany", lat:51.0, lng:10.0, flag:"🇩🇪", desc:"Castles, beer gardens, fairy-tale forests, and cutting-edge innovation.",
    cities:[
      ...
      {name:"Munich",  lat:48.1351, lng:11.5820, type:"culture", desc:"Beer gardens, Oktoberfest, and Baroque Marienplatz.", imgs:["munich_1","munich_2","munich_3","munich_4"]},
  ...
  { name:"Netherlands", lat:52.5, lng:5.0, flag:"🇳🇱", desc:"Windmills, tulip fields, golden age canals, and vibrant cycling culture.",
    cities:[
      {name:"Amsterdam", lat:52.3702, lng:4.8952, type:"sightseeing", desc:"Canal rings, Rijksmuseum, Anne Frank House and bike lanes.", imgs:["amsterdam_1","amsterdam_2","amsterdam_3","amsterdam_4"]},
    ]},
  ...
  { name:"Qatar", lat:25.3, lng:51.2, flag:"🇶🇦", desc:"Futuristic skylines, desert dunes, and a crossroads of ancient trade routes.",
    cities:[
      {name:"Doha", lat:25.2854, lng:51.5310, type:"sightseeing", desc:"Ultramodern capital with the Museum of Islamic Art and Souq Waqif.", imgs:["doha_1","doha_2","doha_3","doha_4"]},
    ]},
  ...
  { name:"United Arab Emirates", lat:24.0, lng:54.5, flag:"🇦🇪", desc:"Desert dunes, ultramodern towers, souk culture, and luxury at every turn.",
    cities:[
      ...
      {name:"Abu Dhabi", lat:24.4539, lng:54.3773, type:"sightseeing",  desc:"Capital city of stunning mosques, museums, and Formula 1.", imgs:["abu_dhabi_1","abu_dhabi_2","abu_dhabi_3","abu_dhabi_4"]},
    ]},
  { name:"United Kingdom", lat:54.0, lng:-2.5, flag:"🇬🇧", desc:"Royal heritage, literary legends, rolling countryside, and dynamic cities.",
    cities:[
      ...
      {name:"Edinburgh",  lat:55.9533, lng:-3.1883, type:"culture", desc:"Castle rock, Arthur's Seat, whisky trails and festivals.", imgs:["edinburgh_1","edinburgh_2","edinburgh_3","edinburgh_4"]},
